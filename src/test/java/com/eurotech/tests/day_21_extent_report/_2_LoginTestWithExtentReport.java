...
public class _2_LoginTestWithExtentReport extends TestBase {
    ...
    public void positiveLoginTest_4(){
        ...
        extentLogger=report.createTest("TC001 Pozitive Login Test");
    ...
    public void wrongPasswortTest() {
        ...
        extentLogger=report.createTest("TC003 Nagative Login Test (Wrong Password)");
        ...
        extentLogger.info("veify that earning is displayed");
